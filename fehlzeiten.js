function cleanUpMissingTable() {
  ...
  // scrollTo(0,document.querySelector('body').clientHeight);
  // console.log('cleanUp');
}
...
//   if(tblMissings) {
//   	// const btnSemesterLastEntry = document.querySelector('#btnSemester').nextElementSibling.lastElementChild;

//   // console.log(btnSemesterLastEntry);

//   // btnSemesterLastEntry.click();
...
//   	observerMissingTable.observe(tblMissings.querySelector('tbody'), { childList: true });
